...
table = PrettyTable(["Asset", " Amound Owned", convert + "  Value", "Price", "1h", "24h", "7d"])
...
with open('portfolio.txt') as inp:
    for line in inp:
        ...
        price = quotes['price']
        #print(hour_change, week_change , day_change)
...
print('Portfolio Value: ' + Back.GREEN + portfolio_value_string + '%' + Style.RESET_ALL)
print('API Results last updatet: ' + last_updated_str)
